...
> - **Android v0.7.4**(2026-08-04)——跟读录音回放音量修复:UNPROCESSED 录音自动施加线性增益(最大 +12dB、永不削波,评分不受影响),安静录音回放不再偏小;网络错误提示不再泄露服务器公网 IP。见 [NativeLingoAndroid/README.md](NativeLingoAndroid/README.md)。
